...
public class ConsoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        categories.add("Tahıl urunleri");
        categories.add("Icecekler");
        categories.add("Et ve Balık");
        categories.add("Sebzeler ve meyveler");
        categories.add("Tatlı");
        categories.add("Sut Urunleri");
        categories.add("Karısık yemekler");
        categories.add("Diger");
